  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return Dialog(
                    ...
                    slivers: <Widget>[
                      SliverList(
                        delegate: SliverChildListDelegate(
                          <Widget>[
                            Text("《Easy解压缩用户协议》", textAlign: TextAlign.center, style: TextStyle(
                              fontSize: 20
                            )),
                            Html(
                              data: """<p>请您本产品之前，请务必仔细阅读并理解《用户许可使用协议》（以下简称“本协议”）中规定的多有权利和限制。
        ...
        <p>本协议适用中华人民共和国法律；
            <br/>如果双方发生纠纷，应本着友好的圆柱协商解决；如协商不成，应向所在地的法院提起诉讼。
        </p>
